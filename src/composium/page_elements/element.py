...
class Element:
    ...
    def __init__(
        ...
        *,
        ...
        self._query = Query(locator, multiple=multiple, wrap=item)
        self._mixin = mixin
        self._polling = polling

    def __repr__(self) -> str:
        return f"<{self.__class__.__name__}({self._query.locator.by}='{self._query.locator.value}')>"
    ...
    def _create_lazy_element(self, parent: t.Any) -> LazyElement:
        ...
        return LazyElement(self._query, parent, mixin=self._mixin, polling=self._polling)
